...
\begin{frame}{Contribution 1: Survey}{Extract statistics}
    Methods
    \begin{figure}
        \includesvg[width=0.33\columnwidth]{survey/layers.svg}
        \hfill
        \includesvg[width=0.33\columnwidth]{survey/input.svg}
        \hfill
        \includesvg[width=0.33\columnwidth]{survey/algorithm.svg}
    \end{figure}
    \begin{itemize}
        \item PPG
        \item Deep Learning
