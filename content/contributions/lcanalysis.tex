...
\begin{frame}{Contribution 4: Learning Curve Analysis}{Results}
    \begin{figure}[htbp]
        \includesvg[width=0.43\columnwidth]{lcanalysis/lc analysis SBP MAE.svg}
        \includesvg[width=0.43\columnwidth]{lcanalysis/lc analysis SBP SD.svg}

        \includesvg[width=0.43\columnwidth]{lcanalysis/lc analysis DBP MAE.svg}
        \includesvg[width=0.43\columnwidth]{lcanalysis/lc analysis DBP SD.svg}
    \end{figure}
