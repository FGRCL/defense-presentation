...
\begin{frame}{Contribution 2: Model Reproduction}{Chen et al.}
    \begin{figure}
        \includegraphics[width=\columnwidth]{reproductions/chen.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Contribution 2: Model Reproduction}{Schrumpf et al.}
    \begin{figure}
        \includegraphics[width=0.45\columnwidth]{reproductions/alex.png}
        \hfill
        \includegraphics[width=0.45\columnwidth]{reproductions/resnet.png}
    \end{figure}
    ResNet34
\end{frame}
