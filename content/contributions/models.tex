...
\begin{frame}{Contribution 3: Proposed Models}{Residual CNN}
    \begin{columns}
        \column{0.5\columnwidth}
        \begin{figure}
            \includesvg[width=0.35\columnwidth]{models/Residual Conv.svg}
            \hfill
            \includesvg[width=0.35\columnwidth]{models/Residual Conv - Residual Block.svg}
        \end{figure}
...
\begin{frame}{Contribution 3: Proposed Models}{Transformer Encoder}
    \begin{columns}
        \column{0.5\columnwidth}
        \begin{figure}
            \includesvg[width=0.35\columnwidth]{models/Transformer Encoder.svg}
        \end{figure}
...
\begin{frame}{Contribution 3: Heartbeat Sequence Input}{Methodology}
    ...
    \begin{figure}
        \includegraphics[width=0.4\columnwidth]{inputs/window.png}

        \includegraphics[width=0.4\columnwidth]{inputs/heartbeat.png}
        \hfill
        \includegraphics[width=0.4\columnwidth]{inputs/heartbeat-sequence.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Contribution 3 \& 4}{Results}
    \begin{figure}[htbp]
        \centering
        \includesvg[width=0.42\columnwidth]{results/preprocessing random split SBP Mean Absolute Error.svg}
        \includesvg[width=0.42\columnwidth]{results/preprocessing random split DBP Mean Absolute Error.svg}

        \includesvg[width=0.42\columnwidth]{results/preprocessing patient split SBP Mean Absolute Error.svg}
        \includesvg[width=0.42\columnwidth]{results/preprocessing patient split DBP Mean Absolute Error.svg}
    \end{figure}
    \begin{itemize}
